...
export const ITEMS: Item[]= [
    ...
    {tag:["L","ct","M"],unit:"kg",id:1,name:"スナッッチ"},
    ...
    {tag:["L","ct","W"],unit:"kg",id:51,name:"スナッッチ"},
    {tag:["L","ct","W"],unit:"kg",id:53,name:"フルスクワット"},
    {tag:["J","ct","W"],unit:"m",id:55,name:"両手砲丸投げ（後）"},
    {tag:["S","ct","W"],unit:"sec",id:62,name:"20+30mRS"},
    // 専門種目
    {tag:["J","sp"],unit:"m",id:102,name:"三段跳"},
    {tag:["J","sp"],unit:"m",id:104,name:"棒高跳"},
    {tag:["J","sp"],unit:"m",id:103,name:"走高跳"},
    {tag:["J","sp"],unit:"m",id:101,name:"走幅跳"},
];
